...
export default function Features(){
    return <section id="features" className="relative px-10 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div className="max-w-full mx-auto">
            ...
            <div className="space-y-16 sm:space-y-20 lg:space-y-32">
                {features.map((feature, key) => (
                    <div key={key} className={`flex flex-col lg:flex-row text-center gap-8  sm:gap-12 
                        ...
                        <div className="flex-1 w-full">
                            <div className="relative group">
                                ...
                                <div className="relative bg-gray-950/50 backdrop-blur-sm border border-gray-700/50 
                                    ...
                                    {/** IDE */}
                                    <div className="bg-gray-950 rounded-lg p-3 sm:p-4 text-xs sm:text-sm font-mono">
                                        {/** IDE HEADER */}
                                        <div className="flex items-center space-x-1 sm:space-x-2 mb-3 sm:mb-4">
                                            ...
                                            <span className="text-gray-400 ml-2 text-xs sm:text-sm ">{feature.title}</span>
                                        </div>
                                        <div>
                                            <SyntaxHighlighter
                                                style={nightOwl} 
                            ...
                            <div className="flex-1 w-full">
                                <div className="max-w-lg mx-auto lg:mx-0 text-center lg:text-left">
                                    ...
                                    <p className="textt-gray-300 text-base sm:text-lg leading-relaxed">{feature.description}</p>
                                </div>
                            </div>              
                    </div>
                ))}
